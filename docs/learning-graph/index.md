# Learning Graph for Cybersecurity: Foundations, Practice, and Professional Responsibility
...
This course contains 390 concepts spanning the eight CSEC2017 knowledge areas, foundational principles, operations, emerging topics, and capstones.
...
- Foundational concepts and entry points
...
into a single primary classifier.  The 12 categories used here align with the eight CSEC2017
knowledge areas (Data, Software, Component, Connection, System, Human, Organizational, Societal Security)
plus foundations, operations, emerging topics, and capstones.

- A concept classifier taxonomy with approximately 12 categories
- Category organization — foundational elements first, course capstone project ideas last
- Balanced categories (1.3% - 15.6% each)
