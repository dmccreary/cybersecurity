...
|---|---------|-------|--------|-------|
| 1 | Concepts | 390 | Required | Concepts from learning graph |
...
| 7 | Glossary Terms | 390 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 90 | Recommended | Questions in faq.md |
| 9 | Words | 139,778 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 72 | 72 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 1 | LaTeX expressions (inline and display) |
| Total Words | 139,778 | 103,463 | Words in markdown files |
| Links | 195 | 54 | Hyperlinks in markdown format |
| Equivalent Pages | 577 | 432 | Estimated pages (250 words/page + visuals) |
